...
export const PLACEHOLDER_GROUPS = {
  Imóvel: [
    ...
    "property.registry_book",
    "property.registry_pages",
    "property.registry_issue_date",
    "property.registry_region",
    "property.bedrooms",
    "property.bathrooms",
    "property.suites",
...
export const PLACEHOLDER_LABELS: Record<string, string> = {
  ...
  "property.total_area_m2": "Área total do imóvel (m²)",
  "property.width_m": "Largura do imóvel (m)",
  "property.length_m": "Comprimento do imóvel (m)",
  "property.lot_number": "Lote do imóvel",
  "property.block_number": "Quadra do imóvel",
  "property.registry_office": "Cartório do registro",
  "property.registry_number": "Número de matrícula",
  "property.registry_book": "Livro do registro",
  "property.registry_pages": "Folhas do registro",
  "property.registry_issue_date": "Data de expedição do registro",
  "property.registry_region": "Região do cartório de registro",
...
export function buildPlaceholderContext(input: {
  ...
  return {
    property: {
      ...
      total_area_m2: input.property?.total_area_m2 ?? "",
      width_m: input.property?.width_m ?? "",
      length_m: input.property?.length_m ?? "",
      lot_number: input.property?.lot_number ?? "",
      block_number: input.property?.block_number ?? "",
      registry_office: input.property?.registry_office ?? "",
      registry_number: input.property?.registry_number ?? "",
      registry_book: input.property?.registry_book ?? "",
      registry_pages: input.property?.registry_pages ?? "",
      registry_issue_date: fmtDate(input.property?.registry_issue_date),
      registry_region: input.property?.registry_region ?? "",
