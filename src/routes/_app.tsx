...
import { LayoutDashboard, Home, Users, UserCog, Plug, LogOut, FileText, KeyRound, Settings, Menu, ClipboardCheck, Handshake } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-30 flex h-14 items-center gap-2 border-b bg-background px-3 md:hidden">
          ...
          <img src={logo} alt="House302" className="h-6 w-auto" />
        </header>
